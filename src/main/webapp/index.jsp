...
<html lang="zh"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <title>云R记</title>
    <link href="statics/Home_files/note.css" rel="stylesheet">
    <link href="statics/Home_files/bootstrap.css" rel="stylesheet">
    <link href="statics/Home_files/sweetalert2.min.css" rel="stylesheet">
    <script src="statics/Home_files/jquery-1.11.3.js"></script>
    <script src="statics/Home_files/bootstrap.js"></script>
    <script src="statics/Home_files/sweetalert2.min.js"></script>
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                ...
                <li <c:if test="${menu_page=='peport'}">class="active"</c:if> ><a href="report?actionName=info"><i class="glyphicon glyphicon-signal"></i>&nbsp;数据报表</a></li></ul>
            <form class="navbar-form navbar-right" role="search" action="index">
                <div class="form-group">
                    <input type="hidden" name="actionName" value="searchTitle">
                    <input type="text" name="title" class="form-control" placeholder="搜索云记" maxlength="" value="${title }" >
                </div>
                        ...
                        <c:forEach items="${typeInfo}" var="item">
                            <li id="li_${item.typeId}">
                                <a href="index?actionName=searchType&typeId=${item.typeId}">
                                     <span id="sp_${tiem.typeId}">${item.groupName}</span>
